...
<!-- Typing Animation -->
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=800&color=6366F1&center=true&vCenter=true&multiline=false&width=650&lines=Hi+there!+I'm+Susan+Acharya+%F0%9F%91%8B;Aspiring+Web+Developer;Building+Scalable+Web+Applications" alt="Typing SVG" />
</div>
...
| **Task Manager API** | RESTful API for task management with full CRUD, built with Django REST Framework | `JS` `Python` `DRF` | [![Repo](https://img.shields.io/badge/Code-181717?style=flat-square&logo=github)](https://github.com/susancodex/task-manager-api) [![Live](https://img.shields.io/badge/Live-00C7B7?style=flat-square&logo=render&logoColor=white)](https://task-manager-api-x87n.onrender.com) |
